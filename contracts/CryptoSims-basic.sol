...
contract TheFunixCryptoSim is ERC721, Ownable  {
        ...
        returns (SimAttributes memory)
    {
        ...
        attributes.generation = matronAttr.hiddenGenes + 1;
        ...
        // START CODE HERE
        attributes.body = (matronAttr.hiddenGenes * sireAttr.hiddenGenes + 3) % 4;
        if (x==0) {
            attributes.eye = sireAttr.hiddenGenes;
            attributes.hairstyle = matronAttr.hiddenGenes;
            attributes.outfit = (sireAttr.hiddenGenes + matronAttr.hiddenGenes + 1 ) % 32;
            attributes.accessory = (sireAttr.hiddenGenes + matronAttr.hiddenGenes) % 32;
            attributes.hiddenGenes = 0;
        } else if (x==1) {
            attributes.eye = matronAttr.hiddenGenes;
            attributes.hairstyle = (sireAttr.hiddenGenes - matronAttr.hiddenGenes + 128 ) % 128;
            attributes.outfit = (sireAttr.hiddenGenes + matronAttr.hiddenGenes + 1 ) % 32;
            attributes.accessory = (sireAttr.hiddenGenes + matronAttr.hiddenGenes) % 32;
            attributes.hiddenGenes = 1;

        } else if (x==2) {
            attributes.eye = (sireAttr.hiddenGenes + matronAttr.hiddenGenes ) % 8;
            attributes.hairstyle = (sireAttr.hiddenGenes - matronAttr.hiddenGenes + 128 ) % 128;
            attributes.outfit = (sireAttr.hiddenGenes + matronAttr.hiddenGenes) % 32;
            attributes.accessory = (sireAttr.hiddenGenes + matronAttr.hiddenGenes + 31) % 32;
            attributes.hiddenGenes = 2;

        } else if  (x==3) {
            attributes.eye = (sireAttr.hiddenGenes + matronAttr.hiddenGenes ) % 8;
            attributes.hairstyle = sireAttr.hiddenGenes;
            attributes.outfit = (sireAttr.hiddenGenes + matronAttr.hiddenGenes) % 32;
            attributes.accessory = (sireAttr.hiddenGenes + matronAttr.hiddenGenes + 31) % 32;
            attributes.hiddenGenes = 2;
